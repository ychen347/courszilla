...
PLATFORM_NAME = "Courszilla"
CC_MERCHANT_NAME = PLATFORM_NAME
PLATFORM_TWITTER_ACCOUNT = "@CourszillaTritter"
PLATFORM_FACEBOOK_ACCOUNT = "http://www.facebook.com/Courszilla"
...
FEATURES = {
    ...
    #  'DEBUG_LEVEL':0,  # 0 = lowest level, least verbose, 255 = max level, most verbose
     'DEBUG_LEVEL': 50,  # 0 = lowest level, least verbose, 255 = max level, most verbose
     #Jeff modified above line.
...
DEFAULT_FROM_EMAIL = 'registration@courszilla.com'
DEFAULT_FEEDBACK_EMAIL = 'feedback@courszilla.com'
SERVER_EMAIL = 'devops@courszilla.com'
TECH_SUPPORT_EMAIL = 'technical@courszilla.com'
CONTACT_EMAIL = 'info@courszilla.com'
BUGS_EMAIL = 'bugs@courszilla.com'
UNIVERSITY_EMAIL = 'university@courszilla.com'
PRESS_EMAIL = 'press@courszilla.com'
ADMINS = ()
MANAGERS = ADMINS
...
BULK_EMAIL_DEFAULT_FROM_EMAIL = 'no-reply@courszilla.com'
